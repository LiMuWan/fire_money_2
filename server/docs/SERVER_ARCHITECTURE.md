...
- `build_one_to_two_doctor_report()` checks strategy config, market data, local state storage, Feishu environment, scheduler readiness, and scheduler audit storage without sending notifications or creating paper trades.
