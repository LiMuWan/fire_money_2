...
- Render candidate pool, position labels, stop loss, strict T+1 risk notes, runtime doctor checks, paper-account state, local schedule state, Feishu notification status, notification records, end-of-day review, and stability observation.
